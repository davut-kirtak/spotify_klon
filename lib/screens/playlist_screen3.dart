...
class PlaylistScreen3 extends StatefulWidget {
  @override
  _PlaylistScreen3State createState() => _PlaylistScreen3State();
}

class _PlaylistScreen3State extends State<PlaylistScreen3> {
  List<dynamic> _songs = [];
  ...
  void initState() {
    super.initState();
    fetchSongs('indie'); // Indie türündeki şarkıları çek
  }
