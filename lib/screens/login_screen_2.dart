...
import 'liked_songs_manager.dart'; // Import the LikedSongsManager
  ...
  Future<void> _signIn() async {
    if (_formKey.currentState?.validate() ?? false) {
      try {
        ...
        // Set the user's email in the LikedSongsManager
        LikedSongsManager().setUserEmail(userCredential.user?.email ?? '');
        ...
        // Handle Firebase errors and show messages
        String errorMessage;
        switch (e.code) {
          case 'user-not-found':
